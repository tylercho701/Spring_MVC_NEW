				...
				<div class="card-body">
					<form:form action="${root }board/modify_procedure" method="post" modelAttribute="modifyContentBean" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<form:input path="content_writer_name" class="form-control" value="${modifyContentBean.content_writer_name }" readonly="true"/>
						</div>
						<div class="form-group">
							<form:label path="content_date">작성날짜</form:label>
							<form:input path="content_date" class="form-control" value="${modifyContentBean.content_date }" readonly="true"/>
						</div>
						<div class="form-group">
							<form:label path="content_subject">제목</form:label>
							<form:input path="content_subject" class="form-control" value="${modifyContentBean.content_subject }"/>
							<form:errors path="content_subject" style="color:red;"/>
						</div>
						<div class="form-group">
							<form:label path="content_text">내용</form:label>
							<form:textarea path="content_text" class="form-control" rows="10" style="resize:none" value="${modifyContentBean.content_text }" />

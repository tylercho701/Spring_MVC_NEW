...
public interface BoardMapper {
	...
	@Select("select u.user_name as content_writer_name, to_char(c.content_date, 'YYYY-MM-DD') as content_date, c.content_subject, c.content_text, c.content_file from content_table c inner join user_table u on u.user_idx = c.content_writer_idx where content_idx = #{content_idx}")

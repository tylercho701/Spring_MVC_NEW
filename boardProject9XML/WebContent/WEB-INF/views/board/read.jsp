			...
			<div class="card shadow">
				<div class="card-body">
					<div class="form-group">
						...
						<input id="content_writer_name" name="content_writer_name" class="form-control" value="${contentInfo.content_writer_name }" disabled="true"/>
					</div>
					<div class="form-group">
						<label id="content_date">작성날짜</label>
						<input id="content_date" name="content_date" class="form-control" value="${contentInfo.content_date }" disabled="true"/>
					</div>
					<div class="form-group">
						<label id="content_subject">제목</label>
						<input id="content_subject" name="content_subject" class="form-control" value="${contentInfo.content_subject }" disabled="true"/>
					</div>
					<div class="form-group">
						<label id="content_text">내용</label>
						<textarea id="content_text" name="content_text" class="form-control" rows="10" style="resize:none" disabled="true">${contentInfo.content_text }</textarea>
					</div>

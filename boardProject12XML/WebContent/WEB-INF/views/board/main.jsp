			...
			<table class="table table-hover" id='board_list'>
				...
				<tbody>
					<c:forEach var="cList" items="${contentList }">
						<tr>
							<td class="text-center d-none d-md-table-cell">${cList.content_idx }</td>
							<td><a href='${root }board/read?board_info_idx=${board_info_idx }&content_idx=${cList.content_idx }&page=${page }'>${cList.content_subject }</a></td>
							<td class="text-center d-none d-md-table-cell">${cList.content_writer_name }</td>
							<td class="text-center d-none d-md-table-cell">${cList.content_date }</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
